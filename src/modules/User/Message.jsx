      ...
      <li className="item" style={{"lineHeight": "34px"}}>
        ...
        <div className="item-content">
          <div className="item-content-title">
            ...
            <span style={{"margin": "0px 10px"}}>{`${constant.messageType[message.type]}了你`}</span>
            {!message.has_read && <a href="javascript:;" onClick={this.markMsg} className="float-right">已读</a>}
          </div>
        </div>
      </li>
    )
